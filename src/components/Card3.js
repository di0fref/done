...
export const Card3 = ({id, card, index, moveCard}) => {
    ...
    return (
        ...
        <div className={'flex items-center justify-start rounded-2xl h-14 mb-4 bg-white space-x-3 hover:cursor-pointer hover:bg-gray-50_'}>
